...
public class LateFeeRuleService
{
	...
	public async Task<ResponseModel> GetLateFeeRules()
	{
		ResponseModel responseModel = new();
		try
		{
			var lateFeeRules = await _context.LateFee.ToListAsync();
			responseModel.IsSuccess = true;
			responseModel.Message = "Succesfully retrieved.";
			responseModel.Data = lateFeeRules;
			return responseModel;
		}
		catch (Exception ex)
		{
